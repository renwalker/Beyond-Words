<?php
    ...
    */
    ...
    class CC_Utility {
        ...
        var $login = 'bey@ndw@rdzpub1'; //Username for your account
        var $password = '4getaboutit'; //Password for your account
        var $apikey = 'bbb967ca-3b4d-4908-b344-9f9461f4dd2e'; // API Key for your account.
        ...
        */    
        protected function doServerCall($request, $parameter = '', $type = "GET") {
           ...
           if ($this->curl_debug) {  $this->lastError = curl_error($ch);   }
           curl_close($ch);
